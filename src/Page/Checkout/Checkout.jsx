...
import { createPayment, verifyPayment } from "../../services/orderApi";
    ...
    return (
        <div className="max-w-2xl mx-auto p-10">
            ...
            <div className="border rounded-lg p-6 mb-6">
                <h2 className="text-xl font-semibold mb-3">Digital Purchase</h2>

                <p className="text-gray-600">You are purchasing digital e-books.</p>
