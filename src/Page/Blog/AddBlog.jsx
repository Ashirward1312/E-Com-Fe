...
//               <h3 className="text-lg font-semibold text-[#0B1C33] mb-4">
//                 SEO Settings
//               </h3>
    ...
    <div className="min-h-screen bg-[#f4f6fb] py-12 px-6">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 mt-3 text-sm">
            Create and publish a new current affair.
          </p>
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                required
                className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#C8A45A] outline-none resize-y"
                placeholder="Write current affair content here..."
              />
