          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                title="YouTube"
                className="w-9 h-9 flex items-center justify-center rounded-xl bg-white/5 hover:bg-[#FF0000]/20 border border-white/10 hover:border-[#FF0000]/40 transition-all duration-300 hover:scale-110 group"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4 fill-[#FF0000]">
              ...
              <a
                ...
                rel="noopener noreferrer"
                title="Facebook"
                className="w-9 h-9 flex items-center justify-center rounded-xl bg-white/5 hover:bg-[#1877F2]/20 border border-white/10 hover:border-[#1877F2]/40 transition-all duration-300 hover:scale-110 group"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4 fill-[#1877F2]">
              ...
              <a
                ...
                rel="noopener noreferrer"
                title="Instagram"
                className="w-9 h-9 flex items-center justify-center rounded-xl bg-white/5 hover:bg-pink-500/20 border border-white/10 hover:border-pink-500/40 transition-all duration-300 hover:scale-110 group"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-4 h-4" style={{fill: 'url(#igGrad1)'}}>
                  <defs>
